...
public class Food{
	...
	/**일회 제공 량*/
	protected double supportpareat;
	/**일회 제공되는 칼로리*/
	...
	public Food(int code, String name, double supportpereat, double calory, double carbo, double protein, double fat,
			...
			String material, String img, String allergy, String type) {
		super();
		this.code = code;
		this.name = name;
		this.supportpareat = supportpereat;
		this.calory = calory;
		this.carbo = carbo;
	...
	public String toString() {
		return "Food [code=" + code + ", name=" + name + ", supportpereat=" + supportpareat + ", calory=" + calory
				+ ", carbo=" + carbo + ", protein=" + protein + ", fat=" + fat + ", sugar=" + sugar + ", natrium="
				+ natrium + ", chole=" + chole + ", fattyacid=" + fattyacid + ", transfat=" + transfat + ", maker="
				+ maker + ", material=" + "material 생략"+", img=" + img + "]\n";
	}
	
	@Override
	public int hashCode() {
		return (Integer.toString(code)).hashCode();
	}
